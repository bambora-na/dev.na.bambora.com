...
|     payment_method        	|     string     	|     The desired method of payment. Available inputs include: Credit Card   - "card", Payment Profile - "payment_profile", Legato   Token - "token", Cash - "cash", Cheque -   "cheque", Interac - "interac", Apple Pay -   "apple_pay", Android Pay - "android_pay".                                        	|
