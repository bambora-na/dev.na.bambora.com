...
You can report on batches of funds transfers and custom commissions payout using the `/scripts/reporting/report.aspx` endpoint. This is covered in a separate document.
